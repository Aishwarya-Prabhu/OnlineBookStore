...
<body style="background-color:lightblue;">
	<center><h1="blue">Online BookStore</h1>
	<h3>Already have an account?</h3>
	<h3> If not, Sign Up here</h3>
	...
	<form action="user/login" method="post">
		...
		<tr>
		    <td>Password:</td>
		    <td><input type="password" name="password" size="30" required="required"/><br/></td>
		</tr>
		
		<tr>
		    <td colspan="2" align="center"><input type="submit" class="btn btn-primary" value="Login" /></td>
		</tr>
